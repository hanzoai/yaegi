...
[![release](https://img.shields.io/github/tag-date/hanzoai/yaegi.svg?label=alpha)](https://github.com/hanzoai/yaegi/releases)
[![Build Status](https://github.com/hanzoai/yaegi/actions/workflows/main.yml/badge.svg)](https://github.com/hanzoai/yaegi/actions/workflows/main.yml)
[![GoDoc](https://godoc.org/github.com/hanzoai/yaegi?status.svg)](https://pkg.go.dev/mod/github.com/hanzoai/yaegi)
...
```go
import "github.com/hanzoai/yaegi/interp"
```

### Command-line executable

```bash
go install github.com/hanzoai/yaegi/cmd/yaegi@latest
```
...
```bash
curl -sfL https://raw.githubusercontent.com/hanzoai/yaegi/master/install.sh | bash -s -- -b $GOPATH/bin v0.9.0
```
...
```console
$ yaegi -syscall -unsafe -unrestricted github.com/hanzoai/yaegi/cmd/yaegi
>
```
...
Go modules are not supported yet. Until that, it is necessary to install the source into `$GOPATH/src/github.com/hanzoai/yaegi` to pass all the tests.
...
[docs]: https://pkg.go.dev/github.com/hanzoai/yaegi
[license]: https://github.com/hanzoai/yaegi/blob/master/LICENSE
[github]: https://github.com/hanzoai/yaegi
[bugs]: https://github.com/hanzoai/yaegi/issues?q=is%3Aissue+is%3Aopen+label%3Abug
